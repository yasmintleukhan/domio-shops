      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="flex flex-col items-center mb-8">
          <div className="w-12 h-12 rounded-2xl bg-[#C9A84C]/10 border border-[#C9A84C]/20 flex items-center justify-center mb-4">
            <ShoppingBag size={22} className="text-[#C9A84C]" strokeWidth={1.5} />
          </div>
          <h1 className="text-xl font-semibold text-[#f5f0e8]">Вход в панель управления</h1>
          <p className="text-[#888880] text-sm mt-1">Управляйте своим магазином</p>
        </div>
        ...
        <p className="text-center text-[#888880]/40 text-xs mt-6">
          Доступ только для авторизованных продавцов
        </p>
      </div>
    </div>
  );
